...
| **Metadata-only evaluation record** | Source-page facts are preserved locally, but no archive/binary is in the repository and source/dependency/compatibility review is incomplete. It is not eligible for a runtime import. |
...
| [S.W.A.T. Operator - SpatialNeglect](https://sketchfab.com/3d-models/swat-operator-9e82fabf26194896b5ad4a364d864eab) | Page-reported CC BY 4.0; archive confirmation pending | Page reports a rigged contemporary tactical operator at 106.7k triangles. | **Metadata-only staged:** [`assets/_staging/spatialneglect-swat-operator/`](assets/_staging/spatialneglect-swat-operator/). It still needs an authorized original archive, dependency attribution, visual review, and authored browser LODs before runtime use. |
...
| --- | --- | --- | --- | --- |
| [Beretta Pistol FPS ANIMATION - BURNER](https://sketchfab.com/3d-models/beretta-pistol-fps-animation-0313ab1888994c14abeaf444d7af3217) | Source-page metadata reported Creative Commons Attribution / CC BY; the exact archive license text/version and linked pistol dependency remain unverified. | Search-index metadata reported 17.9k triangles, 9.1k vertices, and `UP`, `INSPECCION`, `FIRE`, `RELOAD`, `FIRE2`, `RELOAD2`, and `DOWN` actions. The listing says the pistol came from a separately linked source. | **Metadata-only evaluation record** for first-person pistol timing and compatibility research. No archive/binary is staged; it is not an approved M9 replacement or runtime import. | Preserve the original archive and exact license, audit the upstream pistol/dependency chain, verify actual clips/nodes/rig, then prove magazine, slide, muzzle, ADS, and hand-contact compatibility against SPECTER's M9 before any use. |
