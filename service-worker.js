const CACHE='specter-blacksite-v3.0.0';
const CORE=['./','./index.html','./styles.css','./src/main.js','./src/config.js','./src/assets.js','./src/weapons.js','./src/enemies.js','./src/world.js'];
