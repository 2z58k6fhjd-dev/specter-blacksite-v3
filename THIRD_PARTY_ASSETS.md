...
This manifest distinguishes assets that ship with build `5.17.0-MOBILE-AUTO-QA` from links retained
...
autoloader factories plus metadata and animation anchors. Build 5.17.0-MOBILE-AUTO-QA does not
...
`assets/environment/README.txt`, but build 5.17.0-MOBILE-AUTO-QA uses the PBR v2 set for its main
runtime materials.
...
archives or models should be described as included in build 5.17.0-MOBILE-AUTO-QA unless a future
...
is not bundled; build 5.17.0-MOBILE-AUTO-QA uses project-authored procedural vehicle geometry.
...
Build 5.17.0-MOBILE-AUTO-QA uses project-authored procedural Web Audio,
...
Build 5.17.0-MOBILE-AUTO-QA does not integrate sci-fi, futuristic, fantasy, anachronistic,
