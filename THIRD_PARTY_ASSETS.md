...
This manifest distinguishes assets that ship with build `5.12.0-MOBILE-ULTRA-LOW` from links retained
...
autoloader factories plus metadata and animation anchors. Build 5.12.0-MOBILE-ULTRA-LOW does not
...
`assets/environment/README.txt`, but build 5.12.0-MOBILE-ULTRA-LOW uses the PBR v2 set for its main
runtime materials.
...
archives or models should be described as included in build 5.12.0-MOBILE-ULTRA-LOW unless a future
...
is not bundled; build 5.12.0-MOBILE-ULTRA-LOW uses project-authored procedural vehicle geometry.
...
Build 5.12.0-MOBILE-ULTRA-LOW uses project-authored procedural Web Audio,
...
Build 5.12.0-MOBILE-ULTRA-LOW does not integrate sci-fi, futuristic, fantasy, anachronistic,
